function Map(){
    ...
    var exports = function(selection){
        ...
        var shootingCircles = Array.from(arr,function(d){
            ...
            } else if(d.time.getYear()==115 || d.time.getYear()==116){
        ...
        var shootingGroup = L.layerGroup(shootingCircles).addLayer(geojson);

        var map = L.map(mapid, {
            center: [42.323, -71.072],
            zoom: 12,
            layers: [streetMap, shootingGroup],
